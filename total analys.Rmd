...
```{R}
model = coxph(Surv(time_mon, Death) ~  low_decay + high_decay +
                low_growth + high_growth + stable + yoyo, data = t_df22, control = coxph.control(iter.max = 22))
...
ggplot(long_data1, aes(x = date, y = predicted_tumor_size, group = name, color = treatment)) +
