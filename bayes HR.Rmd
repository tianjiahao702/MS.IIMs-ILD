...
# Assuming `fit` is the object returned by the stan_surv() function
posterior_samples <- as.matrix(prior_fit)  # Extracts a matrix of posterior samples

# Compute 95% credible intervals
apply(posterior_samples, 2, quantile, probs = c(0.025, 0.975))

# This returns a matrix with rownames '2.5%' and '97.5%' and column names for each parameter
...
```
```{r}
# Check the posterior predictive checks
...
# If you have another model, you can compare them using loo
# brm_fit2 <- brm(....)
